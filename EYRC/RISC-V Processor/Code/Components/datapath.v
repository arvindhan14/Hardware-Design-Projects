...
wire [31:0] PCNext, PCPlus4, PCTarget, AuiPC, lAuiPC, JalrPC;
wire [31:0] ImmExt, SrcA, SrcB, WriteData, ALUResult;

// next PC logic
mux2 #(32)     pcmux(PCPlus4, PCTarget, PCSrc, PCNext);
mux2 #(32)     jalrmux(PCNext, ALUResult, Jalr, JalrPC);

reset_ff #(32) pcreg(clk, reset, JalrPC, PC);
